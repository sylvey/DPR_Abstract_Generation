...
# sbatch -N 1 -p GPU-shared -t 40:00:00 --gpus=v100-32:1 -A cis230089p test.sh
# squeue -u $USER
...
cd /ocean/projects/cis230089p/slin23/full_text_label/llama
...
python bertscore.py --pairs outputs/pairs.jsonl --limit 10084 --model_type ../led/models/scibert --batch_size 8 --num_layers 9
